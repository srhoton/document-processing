...
FUNCTION_NAME=ComSteverhotonPocDocprocessing
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java${JAVA_MAJOR_VERSION_NUM}
ZIP_FILE=fileb:///Users/steverhoton/git/document-processing/java/com.steverhoton.poc.docprocessing/target/function.zip
...
then
  ...
  ZIP_FILE=fileb:///Users/steverhoton/git/document-processing/java/com.steverhoton.poc.docprocessing/target/function.zip
  FUNCTION_NAME=ComSteverhotonPocDocprocessingNative
